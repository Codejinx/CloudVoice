...
<%
   //String HospitalId =session.getAttribute("DispName").toString();
      String HospName=request.getParameter("hospital_name");
      ...
      try
    {
      ...
      String query="insert into hospdetails (DisplayName,Pwd,Address,City,Country,Phone,Status,Email,Role)values('"+HospName+"','"+Password+"','"+Address+"','"+City+"','"+Country+"','"+ph+"','"+Status+"','"+Email+"','hospital')";
